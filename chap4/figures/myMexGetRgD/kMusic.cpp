...
double kMusic(complex **S, complex **steering, double *doas,double *config, double **s)
{
	...
	int numOfPhaseSpecSamples, numberOfPks,kmax,indxFlag,er;
...
//	....................................................................
//	b = (complex *)malloc(cby2 * sizeof(complex));
...
//	theta = (double *)malloc(numOfPhaseSpecSamples * sizeof(double));
//	s = (double *)malloc(numOfPhaseSpecSamples * sizeof(double));
//	beta = (double *)malloc(numberOfPks * sizeof(double));
//	JkPk = (double *)malloc(numberOfPks * sizeof(double));
//	Phi = (double *)malloc(numberOfPks * sizeof(double));
//	DOA = (double *)malloc(numberOfPks * sizeof(double));
//	AB = (double **)malloc(numberOfPks * sizeof(double *)); // number of rows = # Peaks
//	for (k = 0; k<numberOfPks; k++) AB[k] = (double *)malloc(4 * sizeof(double)); // 4 columns
...
//			for (k = 0; k < numOfPhaseSpecSamples; k++)
//				fprintf(fpKmusic, "%3.4f ,", s[i][k]); fprintf(fpKmusic, "\n");
...
//	.......... Free memory ....................................................
	free(b); 
	free(theta); // s = (free(s), NULL);
	free(beta); free(JkPk); free(Phi);
	free(DOA); 
	myFree2(AB, numberOfPks);
//	for (i = 0; i < numberOfPks; i++) AB[i] = (free(AB[i]), NULL);  // free rows
//	AB = (free(AB), NULL);
//	fclose(fpKmusic);
	return doa;
}
