...
//	....................................
    ...
    plhs[4] = mxCreateDoubleMatrix(1, rcA[1], mxREAL);
    eigValuePtr = mxGetPr(plhs[4]);
...
//        today = getDate();
//        printf("  %s\n", today);
        printf("  updated on 15th Jun 2024 @ 11:30pm Princeton NJ\n");
        ...
        printf("  D = 2; dbyl = 0.1;\n");
        printf("  B = hilbert(x);\n");
        printf("  [muSpk doa1 En SNR eV] = gMusik(D,dbyl,A);\n");
