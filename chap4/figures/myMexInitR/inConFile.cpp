...
void usage(double* rdCon, char* datafile)
{
	...
	printf("!. %s at Hyderabad my talk at Dublin Ohio\n",dateUpdate);
    
	printf("\n\n.............. simple documentaion .........updated on %s\n",dateUpdate);
	return;
}
