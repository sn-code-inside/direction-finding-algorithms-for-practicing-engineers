...
//	Mu = (complex **)malloc(rForMusic * sizeof(complex *));
//	for (i = 0; i < rForMusic; i++) Mu[i] = (complex *)malloc(cby2 * sizeof(complex));
//	.......... for music alogorithm .....................
//	............. this is all for MUSIC .....................
//	........ test each channel for debug ...........
//	for (i = 0; i < rc[0]; i++)
//	{
//		s[0] = (cabs.cabs(S[i][0]));
//		s[1] = (cabs.cabs(S[i][1]));
...
//	}
//	for (k = 0; k < numberOfTgts; k++) printf("%d ", bins[k]); printf("\n");
