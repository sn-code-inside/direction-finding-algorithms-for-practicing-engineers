...
//double** processRdr(int, char*, double*,double**,int *);
...
void traceData(double*, double**, double**, int, int, int);
...
FILE* fp, * fpSyn;
//extern FILE* fpSortCluster, *fpClouds, *fpUnSortCluster, *fpKMUandGmu; // updated on 22nd Aug 2023 for paper
FILE* fpLog;
FILE* fpKMUandGmu;// *fpClouds;
//extern class Cabs :public complex
