...
//    printf("[%d] mexFunction - getRgD.cpp\n",seQ); seQ = seQ + 1;
    ...
    printf(" size of input config vector %d by %d\n",r,LenConfig);
    if ( r != 1) 
    { 
...
//  ....................Free Memory ........................................
    ...
    free(bins); free(config);
    //printf("!. END OF BLOCKS FLAG %d\n", endOfBlocks);
    if (endOfBlocks < 0) printf("!. COMPLETED ALL THE BLOCKS ...\n");
    return;
}
...
void usageGetRgDcLuster(int nlhs, int nrhs)
{
    ...
    printf("  [14 parameters given below] = getRgDcLuster(ComplexADCdata,config);\n");
