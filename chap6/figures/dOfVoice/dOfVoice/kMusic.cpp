...
double kMusic(complex **S, complex **steering, double *doas,double *config, double **s)
{
	...
	double dByLambda = 0.5, max = -1.0, ab[2], Jk, phi;
...
//	....................................................................
	...
	delth = 360.0 / (numOfPhaseSpecSamples - 1);
...
//				fprintf(fpLog, "!. warning: Target [%d] Phase peaks [%d] < (%d)\n",i, abs(indxFlag), numberOfPks);
			...
			for (j = 0; j < numberOfPksNew; j++)
			{
				...
				if (fabs(beta[j]) < 1.0) DOA[j] = asin(beta[j]) * 180 / pi;
			}
...
//  Copy Right Protected  written by Prof Kaluri
//  27th Jul 2017 for     . @ Home Office Princeton NJ
...
//	double *pK, *fn, delf, max = -1.0, *JkClOcal;
	double *fn, delf, max = -1.0, *JkClOcal;
...
//	Normalise JkC
	...
	//	................................................
	delf = 360.0 / ((double)(N - 1));              // -180 to +180
