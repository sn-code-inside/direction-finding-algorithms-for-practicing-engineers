...
void usage()
{
    ...
    printf("Use the mexHEIGmJ\n");
    printf("Updated on 6th Jul 2024 only Usage part\n");
    printf("test the code by using tstEig.m generates a Hermitian\n");
}
